...
if __name__ == '__main__':
    ...
    # print(left_ori)
    point_path = './grasping/data/robot/grasp_point_merge_downsample/lsshirt_bluedot/masked_1722267009660203289_downsampled_0.0045.pcd'
    assert os.path.exists(point_path), 'No such file: {}'.format(point_path)
