...
def basic_train():
    ...
    dataset = GraspDatasetCombined(root_dir='./grasping/data/robot', csv_list=train_files, from_csv=True, first_load=False,
                                   num_points=4096)
    ...
    for file in test_files:
        test_set = GraspDataset(root_dir='./grasping/data/robot', from_csv=True, first_load=False, num_points=4096,
                                csv_file=file)
